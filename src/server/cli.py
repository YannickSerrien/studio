...
Usage examples:
    python3 cli.py --city 3 --cluster c_3_2 --hour 8 --duration 8 --date 2023-01-15
    python3 cli.py --city 1 --best-positions --hour 10 --duration 6 --date 2023-02-01
    python3 cli.py --city 3 --compare-schedules --cluster c_3_2 --date 2023-01-15
"""
...
Examples:
  ...
  python3 cli.py --city 3 --weekly --cluster c_3_2 --hour 8 --duration 8 --date 2023-01-15
        """,
  )
  ...
  try:
    if args.cluster:
        ...
        # Default behavior if no analysis flag is given
        print("No analysis type specified. Defaulting to --best-positions.", file=sys.stderr)
        best_positions = optimizer.analyze_best_starting_positions(
            args.city, args.hour, args.duration, args.date, args.top_k
        )
        results = {
